...
****
* Exports your existing Life contacts and/or group data and/or event data into a CSV file.
...
|=======================================================================
| Example | Command | Result
| Export current life and group data | `export l/life.csv g/groups.csv e/events.csv` |
...
If there are multiple persons with the same amount of time spent, CoderLifeInsights will return a person based on reverse-lexicographical order of the persons with the least amount of time spent.
