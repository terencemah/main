...
|=========================================================================
| Example | Command | Result
| Import Life from file "life.csv" and group data from "groups.csv" | `import l/life.csv +
g/groups.csv` |
Imports your Life from `life.csv` and your group data from `groups.csv`

| Import Life from file "life.csv" at specific file path | `import l/C:\Users\User\Documents
                \life.csv` |
Imports your Life from `C:\Users\Harry\Desktop\Documents
                        \life.csv`

|Import Life from file "life.csv" at specific file path | `import l/./Desktop/life.csv` |
Imports your Life from `C:\Users\Harry\Desktop\Documents
                        \life.csv`
|=========================================================================
...
|=======================================================================
| Example | Command | Result
| Export current life and group data | `export l/life.csv g/groups.csv` |
...
If there are multiple persons with the same amount of time spent,
CoderLifeInsights will return a person based on reverse-lexicographical order of the persons with the least amount of time spent.
...
| Look for a place to do something at | `[coming v1.4]` `suggest place` | Returns a place to go to.
| Look for an activity to do |`[coming v1.4]` `suggest activity` | Returns an activity to do.
|=======================================================================
...
|Edit the members in the 1st group| `edit_group 1 m/1 m/21` | Changes the members of the group with index 1 in CoderLifeInsights to `1 and 2` from whatever
