...
== My Role
I was tasked to implement the AddEventCommand with its relevant classes, and making the inputs from the aforementioned command savable to the hard disk.
...
It also saves the added information to the hard disk. Many improvements and features stem from the data recorded by this command in the Person and Group objects.
...
** Documentation:
*** Added and revised contents of the User Guide (Pull requests: https://github.com/AY1920S2-CS2103-W14-4/main/pull/53[#53], https://github.com/AY1920S2-CS2103-W14-4/main/pull/94[#94], https://github.com/AY1920S2-CS2103-W14-4/main/pull/128[#128])
*** Added contents of the Developer Guide (Pull requests: https://github.com/AY1920S2-CS2103-W14-4/main/pull/79[#79])
...
|===
|_Shwon below are sections I contributed to the Developer Guide. They showcase my ability to write technical documentation and the technical depth of my contributions to the project._
|===
