...
* *Minor enhancement #3*: Implementation of Insights feature for groups `view_groups`
...
*** Tasked to ensure documentation for all code written, as well as ensuring the User Guide understandable and not confusing.
